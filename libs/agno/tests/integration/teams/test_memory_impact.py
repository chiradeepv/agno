...
def test_team_memory_impact_with_gc_monitoring(shared_db, shared_db, memory):
    """
...
def test_team_memory_cleanup_after_session_switch(shared_db, shared_db, memory):
    """
...
@pytest.mark.asyncio
async def test_team_memory_with_multiple_members(shared_db, shared_db, memory):
    """
